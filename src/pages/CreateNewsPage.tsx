...
import { createNews, getAllNewsSlugs } from '@/entities/news/api/news.service';
...
export function CreateNewsPage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      showToast('Новину успішно додано', 'success');
      ...
      console.error(error);
      showToast('Не вдалося створити новину', 'error');
    }
  };
      ...
      <div className="admin-page">
        <div className="admin-shell">
          <div className="admin-topbar">
            <h1 className="admin-title">Додати нову новину</h1>
          ...
          <div className="admin-card">
            <div className="admin-grid">
              ...
              <FormField label="Коротка назва" hint="Генерується автоматично, але можна підправити вручну.">
                <TextInput
                  placeholder="Коротка назва для новини"
                  value={form.slug}
            ...
            <div className="admin-actions">
              <Button onClick={handleSubmit}>Створити новину</Button>
            </div>
          </div>
        </div>
      </div>
